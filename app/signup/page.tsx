      ...
      <Card className="w-full max-w-md border-0 shadow-none bg-white">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription className="text-gray-600">
            Get started with Newton AI and transform your learning
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          >
            {isSigningUp ? (
              <>
                <div className="mr-2 h-4 w-4 animate-spin rounded-full border-2 border-gray-300 border-t-gray-900"></div>
                Creating account...
              </>
            ) : (
              <>
